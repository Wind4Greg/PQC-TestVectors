...
const allKeys = {
    slh128s: {
        ...
        publicKeyMultibase: base58btc.encode(concatBytes(SLHDSA_SHA2_128S, keys128.publicKey))
    },
    slh192s: {
        publicKeyHex: bytesToHex(keys192.publicKey),
        secretKeyHex: bytesToHex(keys192.secretKey),
        publicKeyMultibase: base58btc.encode(concatBytes(SLHDSA_SHA2_192S, keys192.publicKey))
    },
    slh256s: {
        publicKeyHex: bytesToHex(keys256.publicKey),
        secretKeyHex: bytesToHex(keys256.secretKey),
        publicKeyMultibase: base58btc.encode(concatBytes(SLHDSA_SHA2_256S, keys256.publicKey))
    },
}
